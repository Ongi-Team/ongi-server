...
public interface AuthControllerDocs {
    ...
    @Operation(
            summary = "회원가입",
            description = "보호자 정보와 어르신 정보를 함께 등록합니다."
    )
    @ApiResponses({
    ...
    @ApiResponses({
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "404",
                    description = "회원 없음 또는 어르신 정보 없음 (ELDER 모드에서 등록된 어르신이 없는 경우)",
                    content = @Content(
                            mediaType = "application/json",
                            examples = {
                                    @ExampleObject(
    ...
    @Operation(
            summary = "비밀번호 변경",
            description = "아이디와 전화번호 인증 후 비밀번호를 변경합니다."
    )
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "400",
                    description = "유효성 검사 실패 (아이디/전화번호/새 비밀번호 누락 또는 비밀번호 형식 오류)",
                    content = @Content(
                            mediaType = "application/json",
                            examples = @ExampleObject(value = """
                                    {
